...
{
    public partial class BlockD : Form
    {
        public BlockD()
        {
            InitializeComponent();
        ...
        private void BlockD_Load(object sender, EventArgs e)
        {
            ...
            komut.CommandText = "select count(RoomNo) as SAYI from StudentsInfo where RoomNo='D11'";
            ...
            komut2.CommandText = "select count(RoomNo) as SAYI2 from StudentsInfo where RoomNo='D12'";
            ...
            komut3.CommandText = "select count(RoomNo) as SAYI3 from StudentsInfo where RoomNo='D13'";
            ...
            komut4.CommandText = "select count(RoomNo) as SAYI4 from StudentsInfo where RoomNo='D21'";
            ...
            komut5.CommandText = "select count(RoomNo) as SAYI5 from StudentsInfo where RoomNo='D22'";
            ...
            komut6.CommandText = "select count(RoomNo) as SAYI6 from StudentsInfo where RoomNo='D23'";
        ...
        private void lblbos4_Click(object sender, EventArgs e)
        {
            //
        }

        private void lblbos_Click(object sender, EventArgs e)
        {
