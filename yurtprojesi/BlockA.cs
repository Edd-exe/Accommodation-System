...
{
    public partial class BlockA : Form
    {
        public BlockA()
        {
            InitializeComponent();
        ...
        private void BlockA_Load(object sender, EventArgs e)
        {
            ...
            komut.CommandText = "select count(RoomNo) as SAYI from StudentsInfo where RoomNo='A11'";
            ...
            komut2.CommandText = "select count(RoomNo) as SAYI2 from StudentsInfo where RoomNo='A12'";
       ...
       //     con.Close();
            ...
            komut3.CommandText = "select count(RoomNo) as SAYI3 from StudentsInfo where RoomNo='A13'";
           ...
           // con.Close();
            ...
            komut4.CommandText = "select count(RoomNo) as SAYI4 from StudentsInfo where RoomNo='A21'";
            ...
            komut5.CommandText = "select count(RoomNo) as SAYI5 from StudentsInfo where RoomNo='A22'";
           ...
           // con.Close();
            ...
            komut6.CommandText = "select count(RoomNo) as SAYI6 from StudentsInfo where RoomNo='A23'";
